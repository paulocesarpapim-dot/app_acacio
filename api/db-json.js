...
const initialDB = {
  products: [
    ...
    { id: 31, name: "Rapadura Estrela Batida Sabores - 1 Unidade", description: "Rapadura artesanal com diversos sabores", category: "Rapadura", price: 6.00, image_url: "https://acdn-us.mitiendanube.com/stores/001/686/595/products/rapadura-estrela1-57663ca8e38a43e45416214795842316-1024-1024.webp", created_at: new Date().toISOString() },
    { id: 32, name: "Noz da Índia - 10 Sementes", description: "Nozes de qualidade premium do Nordeste", category: "Outros", price: 37.47, image_url: "https://acdn-us.mitiendanube.com/stores/001/686/595/products/noz-da-india-10-sementes-4a41de99c20ea94bb616246949749c93-1024-1024.webp", created_at: new Date().toISOString() },
    { id: 33, name: "Carne Seca Premium", description: "Carne seca tradicional de qualidade", category: "Outros", price: 45.90, image_url: "https://images.pexels.com/photos/5737375/pexels-photo-5737375.jpeg?auto=compress&cs=tinysrgb&h=400&w=400", created_at: new Date().toISOString() },
    { id: 34, name: "Mel Puro Silvestre", description: "Mel natural de qualidade superior", category: "Doces", price: 28.50, image_url: "https://images.pexels.com/photos/312418/pexels-photo-312418.jpeg?auto=compress&cs=tinysrgb&h=400&w=400", created_at: new Date().toISOString() },
    { id: 35, name: "Castanha do Pará", description: "Castanha de pará selecionada", category: "Outros", price: 42.00, image_url: "https://images.pexels.com/photos/2147010/pexels-photo-2147010.jpeg?auto=compress&cs=tinysrgb&h=400&w=400", created_at: new Date().toISOString() },
    { id: 36, name: "Goiabada Cascão Premium", description: "Goiabada artesanal da marca Cascão", category: "Doces", price: 12.90, image_url: "https://images.pexels.com/photos/5632593/pexels-photo-5632593.jpeg?auto=compress&cs=tinysrgb&h=400&w=400", created_at: new Date().toISOString() },
    { id: 37, name: "Cachaça Artesanal", description: "Cachaça pura 100% artesanal", category: "Outros", price: 35.00, image_url: "https://images.pexels.com/photos/5632596/pexels-photo-5632596.jpeg?auto=compress&cs=tinysrgb&h=400&w=400", created_at: new Date().toISOString() },
    { id: 38, name: "Bacalhau Importado", description: "Bacalhau seco de qualidade premium", category: "Outros", price: 89.90, image_url: "https://images.pexels.com/photos/5737374/pexels-photo-5737374.jpeg?auto=compress&cs=tinysrgb&h=400&w=400", created_at: new Date().toISOString() },
  ]
};
